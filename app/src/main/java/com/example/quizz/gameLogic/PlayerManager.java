...
/**
 * The PlayerManager includes methods and operations acting as the main interface between the GUI and the GameManager.
...
public class PlayerManager implements IPlayerManager {
    ...
    public void createNewPlayer(String playerName) throws IllegalArgumentException {
        ...
        if (!this.profiles.nameExists(playerName)) {
            ...
            throw new IllegalArgumentException("Name already used");       //todo exception ändern
        }
