...
public class StatisticsAnalyser implements IStatisticsAnalyser {
    ...
    */
     ...
     * Time GamemodeActivity: Should include the possibility to set time with constructor
     */


    public Player afterRound(List<Question> qList, IGamemode mode, boolean gWon){
/*
        switch(mode){
